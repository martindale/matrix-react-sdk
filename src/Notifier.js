            ...
            plaf.requestNotificationPermission().done((result) => {
                if (result !== 'granted') {
                    ...
                    const description = result === 'denied'
                        ? _t('Grove does not have permission to send you notifications - please check your browser settings')
                        : _t('Grove was not given permission to send notifications - please try again');
